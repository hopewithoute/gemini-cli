...
Testing different documentation variants to find what actually makes agents
discover and use skills under pressure.
...
You have access to skills at `~/.gemini/skills/`. Consider checking for relevant
...
Before working on any task, check `~/.gemini/skills/` for relevant skills. You
should use skills when they exist.

Browse: `ls ~/.gemini/skills/` Search: `grep -r "keyword" ~/.gemini/skills/`
```
...
before you start is choosing to repeat those mistakes.
